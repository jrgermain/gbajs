...
ARMCoreArm.prototype.constructAddressingMode1ImmediateRotate = function (
  immediate,
  rotate
) {
  var cpu = this.cpu;
...
ARMCoreArm.prototype.constructAddressingMode23Immediate = function (
  instruction,
  immediate,
  condOp
) {
...
ARMCoreArm.prototype.constructAddressingMode23Register = function (
  instruction,
  rm,
  condOp
) {
...
ARMCoreArm.prototype.constructAddressingMode2RegisterShifted = function (
  instruction,
  shiftOp,
  condOp
) {
...
ARMCoreArm.prototype.constructAddressingMode4Writeback = function (
  immediate,
  offset,
  rn,
  overlap
...
ARMCoreArm.prototype.constructMSR = function (
  rm,
  r,
  instruction,
  immediate,
...
ARMCoreArm.prototype.constructSBCS = function (rd, rn, shiftOp, condOp) {
  ...
  return function () {
    ...
    if (rd == cpu.PC && cpu.hasSPSR()) {
      ...
      cpu.cpsrV =
        gprs[rn] >> 31 != shifterOperand >> 31 && gprs[rn] >> 31 != d >> 31;
    }
    gprs[rd] = d;
  };
};
...
ARMCoreArm.prototype.constructSUBS = function (rd, rn, shiftOp, condOp) {
  ...
  return function () {
    ...
    if (rd == cpu.PC && cpu.hasSPSR()) {
      ...
      cpu.cpsrC = gprs[rn] >>> 0 >= cpu.shifterOperand >>> 0;
      cpu.cpsrV =
        gprs[rn] >> 31 != cpu.shifterOperand >> 31 && gprs[rn] >> 31 != d >> 31;
    }
    gprs[rd] = d;
  };
};

...
GameBoyAdvanceAudio.prototype.setSquareChannelEnabled = function (
  channel,
  enable
) {
...
GameBoyAdvanceAudio.prototype.writeSquareChannelSweep = function (
  channelId,
  value
) {
...
GameBoyAdvanceAudio.prototype.writeSquareChannelDLE = function (
  channelId,
  value
) {
  var channel = this.squareChannels[channelId];
...
GameBoyAdvanceAudio.prototype.writeSquareChannelFC = function (
  channelId,
  value
) {
  var channel = this.squareChannels[channelId];
...
GameBoyAdvanceAudio.prototype.updateSquareChannel = function (channel, cycles) {
  ...
  if (channel.doSweep && cycles >= channel.nextSweep) {
    channel.frequency +=
      channel.sweepIncrement * (channel.frequency >> channel.sweepSteps);
